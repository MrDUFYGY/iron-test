resumen-procesos-content<script lang="ts">
...
<div class="relative z-10">
  ...
  >
    <!-- <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 2a1 1 0 00-1 1v5h14V3a1 1 0 00-1-1H6zm13 7H5a3 3 0 00-3 3v6a1 1 0 001 1h3v3a1 1 0 001 1h10a1 1 0 001-1v-3h3a1 1 0 001-1v-6a3 3 0 00-3-3zm-3 11H8v-4h8v4zm1-9a1 1 0 110-2 1 1 0 010 2z" /> 
    </svg> -->
    {buttonText}
  </button>
</div>
